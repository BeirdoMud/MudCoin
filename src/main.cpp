...
static CBigNum bnInitialHashTarget(~uint256(0) >> 22);
...
string GetWarnings(string strFor)
{
    ...
    if (Checkpoints::IsSyncCheckpointTooOld(60 * 60 * 24 * 365) && !fTestNet)
    {
        nPriority = 100;
