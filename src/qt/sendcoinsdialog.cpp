...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(MudcoinUnits::formatWithUnit(MudcoinUnits::MUD, rcp.amount), rcp.label.toHtmlEscaped(), rcp.address));
    }
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(MudcoinUnits::formatWithUnit(MudcoinUnits::MUD, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
