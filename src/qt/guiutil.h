...
namespace GUIUtil
{
    ...
    // Parse "mudcoin:" URI into recipient object, return true on succesful parsing
    // See Mudcoin URI definition discussion here: https://mudcointalk.org/index.php?topic=33490.0
