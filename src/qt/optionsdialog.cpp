        ...
        QWidget(parent)
{
    ...
    mudcoin_at_startup = new QCheckBox(tr("&Start MudCoin on window system startup"));
    mudcoin_at_startup->setToolTip(tr("Automatically start MudCoin after the computer is turned on"));
    layout->addWidget(mudcoin_at_startup);
    ...
    map_port_upnp->setToolTip(tr("Automatically open the MudCoin client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    fee_edit = new MudcoinAmountField();
...
void MainOptionsPage::setMapper(MonitoredDataMapper *mapper)
{
    ...
    mapper->addMapping(mudcoin_at_startup, OptionsModel::StartAtStartup);
#ifndef Q_WS_MAC
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show MudCoin addresses in the transaction list"));
