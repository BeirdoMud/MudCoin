...
static const uint256 hashGenesisBlockOfficial("0x000000fc700c3a2e6b3ed932d4eace833f0c216e55a915e3a6fca1afd490e2d6");
...
public:
    ...
    {
        // mudcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // mudcoin: get transaction coin age
...
public:
    ...
    // mudcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // mudcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // mudcoin: get max transaction timestamp
    ...
    unsigned int GetStakeEntropyBit() const; // mudcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // mudcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // mudcoin: block index flags
    enum
    {
